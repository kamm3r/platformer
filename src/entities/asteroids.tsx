...
import { useSegmentedBucket } from '../lib/segementBucket';
import { ECS, Entity, physics, PhysicsLayers } from '../ecs';
...
export const Asteroids = () => {
  ...
  console.log(
    'Rerendering Asteroids component. You should only see this once.'
  );
